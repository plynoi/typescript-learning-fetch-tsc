...
// Testing Node.js Native Fetch API - using TypeScript, Docker and TSC Project
...
const main = async() =>{
    ...
    console.log('Running Main: Testing Node.js Native Fetch API - using TypeScript, Docker and TSC Project')
